...
* [Join the Open Data Initiative email list](https://lists.opendatainitiative.io/mailman/listinfo/opendatainitiative). By joining the mailing list, you become an Open Data Initiative Member. [{{ site.baseurl }}/participate#membership](Find more information on being an Open Data Initiative Member here.)
...
* We will continue to hold monthly webinars to work with the public. We will overview the state of our work and next steps at each webinar. [Find the next webinar here](https://opendatainitiative.github.io/events).
