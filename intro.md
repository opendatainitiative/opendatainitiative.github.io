...
We look forward to working with you all in the near future. Thank you for again for your hard work on this issue and for your patience as we iterate through the early stages of our project. **We ask that you next go to the <http://wiki.opendatainitiative.io/> for information on how to participate. Please reach out for more information or if there is ever anything we can do to assist [<join@opendatainitiative.io>].**
