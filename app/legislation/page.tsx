...
const LegislationPage = () => {
  return (
    <div>
      ...
      <p>
        Many open data implementations are the result of good management and their policies. 
        But any good policy can be modified by a change in management. To make good policy permanent, 
        the policy must be made into a law. The law must cover just enough detail to establish a 
        framework that the open data implementation can be built upon. We highlight and review open data legislation.
      </p>
      ...
      <p className="mt-4">
        <strong>
          <a href="https://github.com/opendatainitiative/opendatalegislation/tree/0.9.0" target="_blank">
            revision 0.9.0
          </a>
        </strong>
      </p>
