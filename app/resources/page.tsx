export default function ResourcesPage() {
  return (
    <div className="container mx-auto px-4 pt-32">
      ...
      <p className="mb-8">Government, technology, and policy resources organized</p>
      ...
      <section id="states" className="mb-12">
        <h3 className="text-2xl font-semibold mb-4">STATES</h3>
        <p className="mb-4">
      ...
      <section id="us-federal" className="mb-12">
        <h3 className="text-2xl font-semibold mb-4">US FEDERAL</h3>
        <p className="mb-4">
      ...
      <section id="open-data-platforms" className="mb-12">
        <h3 className="text-2xl font-semibold mb-4">OPEN DATA PLATFORMS</h3>
        <p className="mb-4">
      ...
      <section id="policy-organizations" className="mb-12">
        <h3 className="text-2xl font-semibold mb-4">POLICY ORGANIZATIONS</h3>
        <p className="mb-4">
      ...
      <section id="universities" className="mb-12">
        <h3 className="text-2xl font-semibold mb-4">UNIVERSITIES</h3>
        <p className="mb-4">
      ...
      <section id="commercial-companies" className="mb-12">
        <h3 className="text-2xl font-semibold mb-4">COMMERCIAL COMPANIES</h3>
        <p className="mb-4">
